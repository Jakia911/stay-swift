const Filter = () => {
  return (
    <>
      <div classNameName="col-span-3 space-y-4">
        <div>
          <h3 classNameName="font-bold text-lg">Sort By</h3>
          <form action="" classNameName="flex flex-col gap-2 mt-2">
            <label for="highToLow">
        ...
        <div>
          <h3 classNameName="font-bold text-lg">Price Range</h3>
          <form action="" classNameName="flex flex-col gap-2 mt-2">
            <label for="range1">
        ...
        <div>
          <h3 classNameName="font-bold text-lg">Star Category</h3>
          <form action="" classNameName="flex flex-col gap-2 mt-2">
            <label for="fiveStar">
        ...
        <div>
          <h3 classNameName="font-bold text-lg">Amenities</h3>
          <form action="" classNameName="flex flex-col gap-2 mt-2">
            <label for="wifi">
